...
local function creatureSayCallback(cid, type, msg)
	...
	if npcHandler.topic[cid] == 0 then
		if msgcontains(msg, "yes") then
			npcHandler:say("IN WHICH TOWN DO YOU WANT TO LIVE: {Homer}, {Minion}, {Minions}, {Freakazoid}, {Freaka}, {Simpsons}, {Picapau}, {Fred}, {Fredbarney}, {Woodpecker}, {Taz}, {Tazmania}, {Smurf}, {Smurfete}, {Pinkycerebro}, {Leela}, {Futurama}, {Pinguins}, {Madagascar},{Sexo} or {Pink e Cerebro}?", cid)
